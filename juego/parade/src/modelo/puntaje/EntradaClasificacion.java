...
public class EntradaClasificacion implements Serializable, Comparable<EntradaClasificacion > {
  ...
  @Override public int compareTo(EntradaClasificacion  o) {
    ...
    if (c != 0) return c;
    return Long.compare(this.fechaRegistro, o.fechaRegistro);
  }
