...
public class ClienteSwingMain extends JFrame {
  ...
  private JMenuItem miStart, miJugar, miGuardar, miCargar, miTop;
  ...
  public ClienteSwingMain() {
    ...
    startBtn.addActionListener(e -> {
      ...
      if (ok == JOptionPane.OK_OPTION) invokeRemote(() -> ctrl.start());
    });
    ...
    finalPickBtn.addActionListener(e -> {
      ...
      invokeRemote(() -> ctrl.chooseFinalCards(myId, sel));
    });
  ...
  private void playSelected() {
    ...
    invokeRemote(() -> ctrl.playCard(myId, ix));
  }
  ...
  private void conectarYUnirse() {
    try {
      ...
      myId = ctrl.join(myName, new JuegoController.Listener() {
      ...
      if (miGuardar != null) miGuardar.setEnabled(true);
      if (miCargar  != null) miCargar.setEnabled(true);
