...
public class RmiJuegoController implements JuegoController {
  ...
  @Override public String join(String nombre, Listener l) throws Exception {
    this.listener = l;
    return server.join(nombre, new Cb());
  }

  @Override public void start() throws Exception { server.start(); }
  @Override public void playCard(String jugadorId, int index) throws Exception { server.playCard(jugadorId, index); }
  @Override public EstadoJuego getSnapshot() throws Exception { return server.getSnapshot(); }
  @Override public List<EntradaClasificacion> getTopRanking(int n) throws Exception { return server.getTopRanking(n); }
  @Override public void saveGame() throws Exception { server.saveGame(); }
  @Override public void loadGame() throws Exception { server.loadGame(); }
  ...
  @Override
  public void chooseFinalCards(String playerId, int[] indices) throws Exception {
